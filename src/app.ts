...
import {
  ...
  createticket,
  deleteTicket,
} from "./api/v1/controllers/ticketController";
import { ticketValidation } from "./api/v1/validations/ticketValidation";
import {
  getAllStatuses,
  getStatusById,
} from "./api/v1/controllers/statusController";
...
import {
  ...
  getAllFaq,
  updateFaq,
} from "./api/v1/controllers/faqController";
import { faqValidation } from "./api/v1/validations/faqValidation";
...
// FAQ routes (YOUR code)
app.get("/api/faq", getAllFaq);
app.post("/api/faq/create", requireAuth(), faqValidation, createFaq);
app.post("/api/faq/update/:id", requireAuth(), faqValidation, updateFaq);
app.delete("/api/faq/delete/:id", requireAuth(), deleteFaq);
